...
/* sadece "GLOBAL" (TR81 öneki olmadan) da kabul */
const MASTER_SK2='1e42b2640c5332245212c3dbe4e5b64fbcedb296d4899791b63b2b94a05cc5ff';
...
function wireCode(){
  ...
  function submitCode(){
    ...
    const sk=sha256hex(skelCode(codeinput.value));
    if(sha256hex(raw)===MASTER||sk===MASTER_SK||sk===MASTER_SK2){
      grantAccess();
