...
en:{h1:'Discover<br>Türkiye',tag:'Scenic locations across 81 provinces.',scroll:'Scroll ↓',trend:'Trending',trendsub:'The most-visited places.',regions:'Regions',search:'Search a province…',swipe:'Swipe',
  ...
  haveCode:'I have a code',codePh:'Enter your code',codeGo:'Unlock',codeOk:'Unlocked!',codeOkSub:'Taking you in…',codeErr:'That code is not valid.',codeEmpty:'Enter your code.',
  codeDeliver:'Your code is sent with your Shopier purchase.',codeHelp:'Trouble with your code? Message us on Instagram',
...
tr:{h1:'Türkiye<span class="sfx">’yi</span><br>Keşfet',tag:'81 ilin manzaralı konumları.',scroll:'Kaydır ↓',trend:'Popüler',trendsub:'En çok ziyaret edilen yerler.',regions:'Bölgeler',search:'İl ara…',swipe:'Kaydır',
  ...
  haveCode:'Kodum var',codePh:'Kodunu gir',codeGo:'Aç',codeOk:'Açıldı!',codeOkSub:'Yönlendiriliyorsun…',codeErr:'Bu kod geçersiz.',codeEmpty:'Lütfen kodunu gir.',
  codeDeliver:'Kodun, Shopier siparişinle birlikte iletilir.',codeHelp:'Kodla ilgili sorun mu var? Instagram’dan yaz',
